...
export default function PopularWebsereries() {
  ...
  return (
    <div className="bg-black text-white p-6 flex items-center overflow-hidden">
      ...
      <div className="md:w-1/3 lg:w-1/3 w-1/2 text-left">
        <h2 className="font-['Rye'] font-bold md:text-[30px] lg:text-[50px] text-[26px] md:leading-[34.5px] leading-[28.3px] lg:leading-[48px] tracking-[0px]">POPULAR WEBSERIES</h2>
        <button 
          onClick={handleNext} 
